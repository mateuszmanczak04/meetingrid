defmodule CoreWeb.MeetingsLiveViewTest do
  ...
  #   assert has_element?(view_b, "tr > td", "#{user_b_name}")
  #   assert has_element?(view_b, "tr > td", "#{user_a_name}")
  #   assert has_element?(view_a, "tr > td", "#{user_b_name}")
  #   assert has_element?(view_a, "tbody > tr:nth-child(2) > td > button", "Make admin")
  ...
  #   assert has_element?(view_a, "tr > td", "(A) (You) #{new_user_a_name}")
  ...
  #   open_browser(view)
  #   assert has_element?(view, "tr > td", "(A) (You) Unknown")
  # end
end
